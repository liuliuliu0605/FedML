...
parser.add_argument('--topo_name', type=str, default='ring', help='The topology formed by pses')
...
parser.add_argument('--access_link_capacity', type=int, default=1000000000, help='access link capacity')
parser.add_argument('--core_link_capacity', type=int, default=1000000000, help='core link capacity')