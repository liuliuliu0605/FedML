...
LAN_CAPACITY=1e11
LOCAL_UPDATE_TIME=0.0838
WORKER_NUM=$(($GROUP_NUM+1))
GPU_UTIL_PARSE_LIST=(localhost:0,3,0,1,0,1,1,4 localhost:0,4,0,1,0,1,1,3)
...
#          group_comm_round_list=(0 1 10 3 30)
      ...
      do
        ...
        do
            ...
            log_file="fedshakespeare-group_method=$GROUP_METHOD-group_alpha=$GROUP_ALPHA-partition_alpha=$PARTITION_ALPHA-topo=$TOPO_NAME-group_comm_pattern=$GROUP_COMM_PATTERN-group_comm_round=$GROUP_COMM_ROUND.log"
